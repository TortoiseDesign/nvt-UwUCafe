...
Citizen.CreateThread(function()
    exports['qb-target']:AddBoxZone("uwu-servico", vector3(-593.99, -1052.34, 22.34), 1, 1.2, {
        ...
        options = {
            {  
            event = "nvt-UwUCafe:client:Servico",
    ...
    exports['qb-target']:AddBoxZone("uwu-balcao", vector3(-587.59, -1059.67, 22.5), 1.6, 3.6, {
        ...
        options = {
            {
            event = "nvt-UwUCafe:client:Balcao",
            icon = "far fa-clipboard",
            label = "Counter",
            },
        },
    ...
    exports['qb-target']:AddBoxZone("uwu-tabuleiro1", vector3(-584.1, -1062.1, 22.6), 0.5, 0.7, {
        ...
        options = {
            {
            event = "nvt-UwUCafe:client:Tabuleiro1",
            icon = "far fa-clipboard",
            label = "Board",
            },
        },
    ...
    exports['qb-target']:AddBoxZone("uwu-frigorifico", vector3(-591.05, -1058.69, 22.34), 1.6, 1, {
        ...
        debugpoly = false,
            ...
            options = {
                {
                    event = "nvt-UwUCafe:client:FrigorificoComida",
                    icon = "fas fa-laptop",
                    label = "Food Fridge",
                    job = "uwu",
                },
                {
                    event = "nvt-UwUCafe:client:FrigorificoIngredientes",
                    icon = "fas fa-laptop",
    ...
    exports['qb-target']:AddBoxZone("uwu-fogao", vector3(-590.95, -1056.56, 22.28), 0.7, 1.5, {
        ...
        debugPoly=false,
            ...
            options = {
                {
                    event = "nvt-UwUCafe:client:MenuComidas",
                    icon = "fas fa-rocket",
                    label = "Use Stove",
                    job = "uwu",
                },
    ...
    exports['qb-target']:AddBoxZone("uwu-ementa1", vector3(-584.25, -1058.8, 22.37), 0.5, 0.4, {
        ...
        heading=270,
            ...
            options = {
                ...
                {
                    event = "nvt-UwUCafe:client:FaturarPlayer",
                    icon = "fas fa-clipboard",
                    label = "Bill Player",
                    job = "uwu",
                },
    ...
    exports['qb-target']:AddTargetModel(`a_c_cat_01`, {
        options = {
            {
                event = "nvt-UwUCafe:client:AcariciarGato",
                icon = "fas fa-cat",
                label = "Caress cat",
            },
        },
    ...
    exports['qb-target']:AddBoxZone("uwu-bebidas", vector3(-586.95, -1061.92, 22.34), 1, 1, {
        ...
        options = {
            {
            event = "nvt-UwUCafe:client:MenuBebidas",
            icon = "far fa-coffee",
