...
RegisterNetEvent('nvt-UwUCafe:server:FazerCupcakeMorango', function()
    local src = source
...
RegisterNetEvent('nvt-UwUCafe:server:FazerCupcakeLimao', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
    local barramanteiga = Player.Functions.GetItemByName('barra-manteiga')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerCupcakeChocolate', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
    local barramanteiga = Player.Functions.GetItemByName('barra-manteiga')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerGeladoMorango', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('nvt-UwUCafe:server:FazerGeladoChocolate', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotenatas = Player.Functions.GetItemByName('pacote-natas')
    local leitecondensado = Player.Functions.GetItemByName('leite-condensado')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerGeladoBaunilha', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotenatas = Player.Functions.GetItemByName('pacote-natas')
    local leitecondensado = Player.Functions.GetItemByName('leite-condensado')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerPanquencaNutela', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotefarinha = Player.Functions.GetItemByName('pacote-farinha')
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerPanquencaOreo', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotefarinha = Player.Functions.GetItemByName('pacote-farinha')
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerMuffinChocolate', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotefarinha = Player.Functions.GetItemByName('pacote-farinha')
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerWaffleNutela', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotefarinha = Player.Functions.GetItemByName('pacote-farinha')
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerPastelFrango', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacotefarinha = Player.Functions.GetItemByName('pacote-farinha')
    local barramanteiga = Player.Functions.GetItemByName('barra-manteiga')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerCafe', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('nvt-UwUCafe:server:FazerLatte', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
    local graoscafe = Player.Functions.GetItemByName('graos-cafe')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerBubbleTeaAmora', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local water_bottle = Player.Functions.GetItemByName('water_bottle')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerBubbleTeaMorango', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local water_bottle = Player.Functions.GetItemByName('water_bottle')
    local caixamorangos = Player.Functions.GetItemByName('caixa-morangos')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerBubbleTeaMenta', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local water_bottle = Player.Functions.GetItemByName('water_bottle')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerMilkshakeChocolate', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
    local barrachocolate = Player.Functions.GetItemByName('barra-chocolate')
...
RegisterNetEvent('nvt-UwUCafe:server:FazerMilkshakeMorango', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local pacoteleite = Player.Functions.GetItemByName('pacote-leite')
    local caixamorangos = Player.Functions.GetItemByName('caixa-morangos')
...
RegisterNetEvent('nvt-UwUCafe:server:Tirar20dolares', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('nvt-UwUCafe:server:Tirar30dolares', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('nvt-UwUCafe:server:Tirar50dolares', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("cafe-uwu", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:BeberCafe', source)
...
QBCore.Functions.CreateUseableItem("latte-uwu", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:BeberLatte', source)
...
QBCore.Functions.CreateUseableItem("bubble-amora", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:BeberBubbleTea', source)
...
QBCore.Functions.CreateUseableItem("milkshake-chocolate", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:BeberMilkshake', source)
...
QBCore.Functions.CreateUseableItem("cupcake-morango", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:ComerCupcake', source)
...
QBCore.Functions.CreateUseableItem("gelado-morango", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:ComerGelado', source)
...
QBCore.Functions.CreateUseableItem("panqueca-nutela", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:ComerPanqueca', source)
...
QBCore.Functions.CreateUseableItem("muffin-chocolate", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:ComerMuffin', source)
...
QBCore.Functions.CreateUseableItem("waffle-nutela", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:ComerWaffle', source)
...
QBCore.Functions.CreateUseableItem("pastel-frango", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('nvt-UwUCafe:client:ComerPastel', source)
...
RegisterServerEvent("nvt-UwUCafe:server:FaturarPlayer")
AddEventHandler("nvt-UwUCafe:server:FaturarPlayer", function(playerId, amount)
...
RegisterNetEvent('nvt-UwUCafe:Server:AddItem', function(item, amount)
    local Player = QBCore.Functions.GetPlayer(source)
